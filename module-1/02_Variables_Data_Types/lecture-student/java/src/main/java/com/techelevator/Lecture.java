...
public class Lecture {
	...
	public static <str> void main(String[] args) {
		...
		*/
		...
		your phone.
		*/
		int percentOfPhoneBattery = 81;
		System.out.println(percentOfPhoneBattery);
		/*
		...
		*/
		double sumOf = 12.3 + 32.1;
		System.out.println(sumOf);
		/*
		12. Create a String that holds your full name.
		*/
		String fullName = "Jacob Schwartz";
		...
		*/
		...
		String plusString = "Hello, " + fullName;
