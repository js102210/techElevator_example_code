...
public class Exercises {
    ...
    public String firstHalf(String str) {
        int halfPoint = str.length() / 2;
        return str.substring(0, halfPoint);
    }
    ...
    public String middleTwo(String str) {
        int halfPoint = str.length() / 2;
        String result = str.substring(halfPoint - 1, halfPoint + 1);
        if (str.length() == 2) {
            result = str;
        }
        return result;
    ...
    public String middleThree(String str) {
        int exceedsThreeBy = str.length() - 3;
        int marginLength = exceedsThreeBy / 2;
        return str.substring(marginLength, marginLength + 3);
    }
    ...
    public boolean doubleX(String str) {
        ...
        if (str.indexOf('x') != str.lastIndexOf('x')) {
            char afterFirstX = str.charAt(firstX + 1);
            if (afterFirstX == 'x') {
                doubleX = true;
            }
        }
    ...
    public String stringSplosion(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            crazyString += str.substring(0, i + 1);
        }
    ...
    public int last2(String str) {
        if (str.length() > 1) {
            ...
            int countOfFinalTwo = 0;
            for (int i = 0; i < str.length() - 1; i++) {
                if (str.charAt(i) == finalTwo.charAt(0) && str.charAt(i + 1) == finalTwo.charAt(1)) {
                    countOfFinalTwo++;
                }
            }
            return countOfFinalTwo - 1;
        }
        return 0;
    }
    ...
    public String altPairs(String str) {
      String result = "";
        for (int i = 0; i < str.length(); i += 4) {
            int secondHalf = i + 2;
            if (secondHalf > str.length()) {
                secondHalf = str.length();
            }
            result = result + str.substring (i, secondHalf);
        }
