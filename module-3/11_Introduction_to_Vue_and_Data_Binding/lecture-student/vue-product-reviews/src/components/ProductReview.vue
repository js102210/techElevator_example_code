<template>
  <div class="main">
    ...
    <!-- I want the index to use as the key, as an alternative I could have said  
      <v-for ="review in reviews" v:bind-key="review.reviewer" if reviewers were
      only allowed to make one review, it must uniquely identify the review !-->
...
export default {
      ...
      reviews: [
        {
          reviewer: "Zac",
          title: "What a book",
          review: "This book ended my life",
          rating: 3,
        ...
        },
        {
          reviewer: "Zoc",
          title: "What a book",
          review: "This book ended Zac's life",
          rating: 3,
        },
        {
          reviewer: "Zic",
          title: "What a book",
          review: "I am reborn and I will have revenge",
          rating: 5,
        },
      ],
    };
  ...
  computed: {
      averageRating() {
          //use reduce to get total of all ratings
        let sum=this.reviews.reduce( (currentSum, review) => {
              return currentSum + review.rating;},0);
